 ...
 * @author Dulmi
 */
public class login_interface_2 extends javax.swing.JFrame {

    /**
     * Creates new form login_interface_2
     */
    public login_interface_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jToggleButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 270, -1, 40));
        ...
        jPanel1.add(jToggleButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, 160, 40));
        ...
        jToggleButton1.setText("OWNER");
        jToggleButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jToggleButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, 160, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_interface_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_interface_2().setVisible(true);
            }
        });
    }
